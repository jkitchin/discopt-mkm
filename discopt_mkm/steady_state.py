...
from discopt_mkm.assemble import quasi_equilibrium, site_balance_residual
from discopt_mkm.kinetics import net_rate, rate_of_progress
from discopt_mkm.model import MicrokineticModel, _safe
from discopt_mkm.reactors import Reactor
...
class SteadyStateSolution:
    ...
    parameter maps so that :mod:`discopt_mkm.analysis.drc` can build output-rate
...
def solve_steady_state(
    ...
    theta0 : dict, optional
        ...
        :func:`discopt_mkm.numeric.steady_state_numeric` or a transient solve.
    log_box : float
...
def _cstr_energy_residual(mkm, reactor, conc, theta, free_cov, T_expr, energy):
    ...
    """
    from discopt_mkm.energy import heat_release_rate
