...
Each function takes a declarative model spec (see :mod:`discopt_mkm.spec`) and
...
from discopt_mkm.spec import from_spec
...
def degree_of_rate_control(spec, target=None, coordinates="linear"):
    ...
    from discopt_mkm.analysis import degree_of_rate_control as drc
...
def spec_schema() -> dict:
    ...
    from discopt_mkm.spec import ModelSpec
